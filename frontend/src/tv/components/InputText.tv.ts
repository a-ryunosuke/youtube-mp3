    ...
    variants: {
        color: {
            "light": {
                ...
                "input": "text-neutral-700 border-neutral-500 focus:border-red-950"

            },
            "dark": {
                "label": "text-neutral-300",
                "input": "text-neutral-300 border-neutral-700 placeholder:text-neutral-700 focus:border-neutral-300"
            }
