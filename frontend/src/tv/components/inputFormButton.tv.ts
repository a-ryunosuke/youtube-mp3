...
const buttonBase = "p-1 m-3 border-2 rounded-xl text-lg min-w-[80px]"
...
export const inputFormButton = tv({
    ...
    variants: {
        color: {
            light: {
                convertButton: "border-red-400 bg-red-500 hover:bg-red-500 text-neutral-50",
                resetButton: "border-red-400 bg-red-400 hover:bg-red-700 text-neutral-50"
            },
            dark: {
