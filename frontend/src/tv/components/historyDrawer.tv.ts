...
export const historyDrawer = tv({
  slots: {
    ...
    drawer: "fixed top-[60px] mt-1 right-0 h-full w-80 z-50 transition-transform duration-300 overflow-y-auto p-6 flex flex-col gap-4",
    title: "text-lg font-bold mb-2",
    item: "rounded-lg p-4 flex flex-col gap-1 text-sm",
    itemLabel: "font-semibold",
    itemSub: "text-xs opacity-60",
